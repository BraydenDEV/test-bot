...
module.exports.run = async (bot, message, args) => {
  ...
  if(!message.member.hasPermission("KICK_MEMBERS")) return message.reply("No can do.");
  if(args[0] == "help"){
  ...
  let incidentschannel = message.guild.channels.find(`name`, "staff-log");
  if(!incidentschannel) return message.reply("Please create a staff-log channel first!");
